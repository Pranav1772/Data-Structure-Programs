...
{                                       //FUNCTION FOR SORT ARRAY IN ASCENING ORDER USING QUICK SORT METHOD
...
void DescendingOrder(int arr[], int len) //FUNCTION FOR SORT ARRAY IN DESCENING ORDER USING QUICK SORT METHOD
{
