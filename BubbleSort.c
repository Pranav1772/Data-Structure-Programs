...
{                                       //FUNCTION FOR SORT ARRAY IN ASCENING ORDER USING BUBBLE SORT METHOD
    for (int i = 0; i < len; i++)
    {
...
void DescendingOrder(int arr[], int len) //FUNCTION FOR SORT ARRAY IN DESCENING ORDER USING BUBBLE SORT METHOD
{
    for (int i = 0; i < len; i++)
    {
        for (int j = 0; j < len; j++)
